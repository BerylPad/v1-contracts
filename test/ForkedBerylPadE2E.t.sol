...
/// LP2c-full: end-to-end forked BerylPad.deployToken on a Base Sepolia fork.
...
contract ForkedBerylPadE2ETest is BerylPadB20Harness {
    function test_fullFactory_deployToken_e2e() public {
        ...
        address token = a.factory.deployToken(_baseCfg(a, bytes32(uint256(1)), "Minimal BerylPad B20", "MINI", none));
