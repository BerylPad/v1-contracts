...
interface IBerylPadHook {
    ...
    // note: original base IBerylPadHook deployment is missing these functions but
    // the IBerylPadLpFeeConversion locker needs them
